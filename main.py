		...
		MDList:
		    ...
		    TwoLineAvatarListItem:
		        ...
		        MDSwitch:
					...
					on_active: app.theme_change_nd(self, self.active)
						...
						GridLayout:
							...
							FloatLayout:
								MDSwitch:
									...
									active: False
									on_active: root.theme_change(self, self.active)
						MDLabel:
			MDNavigationDrawer:
				id: nav_drawer
...
class Main_Screen(BoxLayout):
    ...
    def theme_change(self, instance, value):
        if value:
            ...
            self.ids.toolbar.md_bg_color = [0.1, 0.1, 0.1, 255]
            self.ids.toolbar.specific_text_color = "Gray"
...
class ClockApp(MDApp):
    ...
    def theme_change_nd(self, instance, value):
        if value:
            clock_app.theme_cls.theme_style = "Light"
            clock_app.theme_cls.primary_palette = "Blue"
            clock_app.theme_cls.accent_palette = "Blue"
